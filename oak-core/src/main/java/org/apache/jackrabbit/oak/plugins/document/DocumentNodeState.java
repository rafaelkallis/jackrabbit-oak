 ...
 */
public class DocumentNodeState extends AbstractDocumentNodeState implements CacheValue, WorkloadAware {
    ...
    private static String keyFromAbsPath(final String absPath) {
        return PathUtils.getDepth(absPath) + ":" + absPath;
    }
